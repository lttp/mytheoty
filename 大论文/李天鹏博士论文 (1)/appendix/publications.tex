...
%    \item IEEE Transactions on Knowledge and Data Engineering, 2021, 学生第一作者
%    \item IEEE Transactions on Neural Networks and Learning Systems, 2022, 学生第一作者
%\end{publist}
%
%\vspace*{1em}
%
...
%\textbf{（三）参与的科研项目}
%\begin{publist}
%	\item 国家重点研发计划项目 (2018YFC0809800)：社区风险监测与防范关键技术研究。
%	\item 国家重点研发计划项目 (2018YFC0832101)：涉案当事人画像自动构建技术研究及系统研发。
%	\item 深圳市可持续发展专项（KCXFZ20201221173013036）：城市风险计算理论与一体化安全云脑研发与应用。
%	
%\end{publist}
%\vfill
